      ...
      <div className="h-full flex flex-row">
        <div className="flex-col flex w-1/2">
          ...
          <h2 className="text-6xl font-bold mt-[15vh]"> 
            <span className="highlighter-orange">WEB DESIGN</span>
          </h2>
          <h2 className="text-6xl font-bold mt-5">
            <span className="highlighter-black text-white">CODING</span>
          </h2>
        </div>
        <div className="absolute right-[10vh] top-[12vh] w-1/3 max-h-[80vh] overflow-hidden text-ellipsis whitespace-nowrap">
          ...
          {/* <p className="max-h-[60vh] text-lg leading-loose text-ellipsis whitespace-pre-wrap">フリーランスのウェブデベロッパーです。<br></br>お客様から寄せられたイメージをもとに、ウェブサイトやスマホアプリのデザイン設計や、開発を行います。<br></br>何よりお客様が伝えたいメッセージをユーザーにお届けすることに重きをおいています。原則サイトはスマートフォンなどモバイル端末に対応するレスポンシブウェブデザインにて設計します。<br></br>見た目だけでなく将来性やお客様の使い勝手を考え、サイトの更新・メンテナンス等も簡単に行えるよう配慮いたします。それもあり、お客様には開発の過程で、取りうるオプションの提示、そしてご判断をして頂く機会を設けていただくこともありますが、その際にはその選択肢のメリット・デメリットをできるだけわかりやすく説明させていただきます。<br></br>過去の制作物は、アットホームなデザインのもの、スタイリッシュなものと様々なデザインがございますが、いずれもお客様の意図を理解しようと努力し、閲覧者に納得していただけるものを目指した結果です。<br></br>これまでご依頼いただいていますお客様にはショップオーナー様、企業のホームページ担当者様、ウェブ制作会社様など様々ですが、いずれも真摯にかつ柔軟に対応しています。ウェブサイトに関することはお気軽にご相談ください。<br></br> 篠崎 拓也</p> */}
        </div>
