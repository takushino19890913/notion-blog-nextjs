    ...
    <div className="flex flex-col relative">
      <Layout>
        ...
        <div className="w-5/6 md:w-2/3 mx-auto flex flex-col mt-20 text-lg md:text-xl justify-between tracking-[.25em]">
          <p>
            1989年生まれ、バンクーバー在住のフルスタックWebデベロッパー、篠崎拓也と申します。
            <br />
            <br />
            ...
            <br />
            <br />
            また、私はWebサイトの開発だけでなく、クライアントの皆様の業務効率化のお手伝いもいたします。ExcelのVBAやPythonを用いて、繰り返しの作業を自動化したり、大量のデータを瞬時に処理したりすることで、作業時間を大幅に短縮することができます。例えば、毎月の経費精算や在庫管理、顧客データの集計など、手作業では時間がかかる業務を自動化することで、クライアントの皆様により多くの時間を創造的な活動に充てていただけるようサポートいたします。
            <br />
            <br />
            プロジェクトの進行には、「アジャイル開発」という手法を取り入れています。これは、従来の一括りな開発ではなく、小さな機能ごとに開発とテストを繰り返しながら、クライアントの皆様からのフィードバックを随時取り入れていく方法です。これにより、クライアントの皆様のニーズに柔軟に対応しつつ、リスクを最小限に抑えながら高品質なプロダクトを開発することができます。
            <br />
            <br />
            また、Webサイトの開発においては、見た目の美しさだけでなく、将来的な拡張性やメンテナンス性、そしてユーザーの使い勝手にも細心の注意を払っています。コードの品質を高く保ち、分かりやすい構造で設計することで、将来の機能追加や変更にも柔軟に対応できるようにしています。さらに、クライアントの皆様にも運用しやすいよう、サイトの管理画面や更新方法についても丁寧にご説明いたします。
            <br />
            <br />
            ...
            <br />
            <br />
            このポートフォリオサイトを通じて、私の技術力と情熱、そして開発者としての姿勢を感じ取っていただければ幸いです。皆様と共に、価値あるプロダクトを生み出していくことを楽しみにしております。お気軽にご相談ください。
          </p>
        </div>
        <div
