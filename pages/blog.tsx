...
export default function Blog({ posts, year_month_list, tag_list }) {
  return (
    <div>
      ...
      <Layout>
        <main className="flex w-11/12 md:w-full flex-col md:flex-row mt-5 md:mt-10 mx-auto">
          <div></div>
          <div className="md:ml-40 md:w-1/6 w-5/6 mx-auto">
          ...
          <div className="mt-10 md:mt-0 mx-auto w-5/6 md:w-1/2 md:mr-40 md:ml-auto">
            <h2 className="text-3xl pb-5 border-b-2 border-dotted border-black">
              All Posts
            </h2>
            <ol className="mt-5">
              {posts.map((post) => {
                ...
                return (
                  <li key={post.id} className="hover-yellow my-10">
                    ...
                    <div className="hidden md:block flex flex-col md:flex-row">
